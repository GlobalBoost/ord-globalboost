...
- Fix UTXO selection in mock GlobalBoost Core instance(#2417)
...
- Throw an error GlobalBoost Core wallet and ord index are out of sync (#1459)
...
### Changed
- Poll GlobalBoost Core less frequently (#1268)
...
- Check GlobalBoost Core version before inscribing (#1048)
...
- Move test GlobalBoost Core RPC server into sub-crate (#569)
...
- Read cookie file from --globalboost-data-dir (#365)
...
- Work with live GlobalBoost Core RPC API (#140)
